...
class MoodDiaryVew extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final _moodFirstHalfAnimation = Tween<Offset>(begin: Offset(2, 0), end: Offset(0, 0)).animate(
      CurvedAnimation(
        parent: animationController,
        curve: Interval(0.4, 0.6, curve: Curves.fastOutSlowIn),
      ),
    );
    final _moodSecondHalfAnimation = Tween<Offset>(begin: Offset(0, 0), end: Offset(-2, 0)).animate(
      CurvedAnimation(
        parent: animationController,
        curve: Interval(0.6, 0.8, curve: Curves.fastOutSlowIn),
      ),
      ...
      child: SlideTransition(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text("Mood Dairy", style: TextStyle(fontSize: 26.0, fontWeight: FontWeight.bold)),
              SlideTransition(
              ...
              SlideTransition(
                ...
                child: SlideTransition(
                  ...
                  child: Container(
                    ...
                    child: Image.asset('assets/introduction_animation/mood_dairy_image.png', fit: BoxFit.contain),
                  ),
                ),
              ),
            ],
